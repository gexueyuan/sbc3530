...
#define MUX_DEFAULT()\
	...
	MUX_VAL(CP(DSS_DATA18),     (IEN  | PTD | DIS | M0)) /*GPIO_88*/\
	MUX_VAL(CP(DSS_DATA19),     (IEN  | PTD | DIS | M0)) /*GPIO_89*/\
	MUX_VAL(CP(DSS_DATA20),     (IEN  | PTD | DIS | M0)) /*GPIO_90*/\
	MUX_VAL(CP(DSS_DATA21),     (IEN  | PTD | DIS | M0)) /*GPIO_91*/\
...
#ifdef CFG_PRINTF
	printf("Platform: OMAP3530 Stalker.\n");
#endif
	
	for(fc1=0;fc1<0xFF;fc1++)
	{
		__raw_writel(fc1,0x80000000);
		if(__raw_readl(0x80000000) != fc1)
		{
#ifdef CFG_PRINTF
