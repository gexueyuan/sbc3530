...
/* Pin mux for SBC3530 REV A */
#define MUX_SBC3530_REV_A() \
 /*SDRC*/\
 ...
 /*Expansion card */\
	...
	MUX_VAL(CP(MMC1_DAT4),		(IEN  | PTU | EN  | M4)) /*GPIO126*/\
	MUX_VAL(CP(MMC1_DAT5),		(IEN  | PTU | EN  | M4)) /*GPIO127*/\
	MUX_VAL(CP(MMC1_DAT6),		(IDIS | PTU | DIS | M4)) /*GPIO128*/\
	MUX_VAL(CP(MMC1_DAT7),		(IDIS | PTU | DIS | M4)) /*GPIO129*/\
 /*Wireless LAN */\
 ...
 /*Serial Interface*/\
	...
	MUX_VAL(CP(HDQ_SIO),		(IDIS | PTU | EN  | M0)) /*HDQ_SIO*/\
 ...
 /*Control and debug */\
	...
	MUX_VAL(CP(ETK_D6_ES2),		(IEN  | PTU | DIS | M4)) /*GPIO_20*/\
